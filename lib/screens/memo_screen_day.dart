...
class MemoScreenDay extends StatefulWidget {
  const MemoScreenDay({super.key});

  @override
  State<MemoScreenDay> createState() => _MemoScreenDayState();
}

class _MemoScreenDayState extends State<MemoScreenDay> {
